...
function Write-Log {
    ...
    $LogFile = "C:\DesktopSupportTools\RemoteScriptExecution_Log_$(Get-Date -Format 'yyyyMMdd_HHmmss').txt"
...
try {
    Write-Host "Script starting at $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss') on 07:15 PM PDT, Sunday, September 21, 2025"
    ...
    try {
        ...
        Write-Log "ERROR: Failed to create or access C:\DesktopSupportTools. Error: $($_.Exception.Message)"
        throw
    }
} catch {
...
# Function to manage processes (native PID feature)
function Manage-Processes {
    ...
    $Form = New-Object System.Windows.Forms.Form
    $Form.Text = "Manage Processes on $TargetIP"
    ...
    $Label.Text = "Search processes by name (leave blank for all):"
    $Form.Controls.Add($Label)
    ...
    $SearchButton.Location = New-Object System.Drawing.Point(10,60)
    $SearchButton.Size = New-Object System.Drawing.Size(100,30)
    $SearchButton.Text = "Search"
    $Form.Controls.Add($SearchButton)

    $ProcessList = New-Object System.Windows.Forms.ListView
    $ProcessList.Location = New-Object System.Drawing.Point(10,100)
    $ProcessList.Size = New-Object System.Drawing.Size(560,200)
    $ProcessList.View = [System.Windows.Forms.View]::Details
    $ProcessList.CheckBoxes = $true
    $ProcessList.Columns.Add("Name", 200) | Out-Null
    $ProcessList.Columns.Add("PID", 100) | Out-Null
    $ProcessList.Columns.Add("Status", 100) | Out-Null
    $Form.Controls.Add($ProcessList)

    $TerminateButton = New-Object System.Windows.Forms.Button
    $TerminateButton.Location = New-Object System.Drawing.Point(10,320)
    $TerminateButton.Size = New-Object System.Drawing.Size(100,30)
    $TerminateButton.Text = "Terminate Selected"
    $Form.Controls.Add($TerminateButton)
    ...
    $SearchButton.Add_Click({
        ...
        try {
            $processes = Invoke-Command -Session $Session -ScriptBlock {
                param($term)
                if ($term) {
                    Get-Process -Name "*$term*" -ErrorAction SilentlyContinue | Select-Object Name, Id, @{Name="Status";Expression={if ($_.Responding) {"Running"} else {"Not Responding"}}}
                } else {
                    Get-Process -ErrorAction SilentlyContinue | Select-Object Name, Id, @{Name="Status";Expression={if ($_.Responding) {"Running"} else {"Not Responding"}}}
                }
            } -ArgumentList $searchTerm
            foreach ($proc in $processes) {
                $item = New-Object System.Windows.Forms.ListViewItem($proc.Name)
                $item.SubItems.Add($proc.Id.ToString()) | Out-Null
                $item.SubItems.Add($proc.Status) | Out-Null
                $ProcessList.Items.Add($item) | Out-Null
            }
            if (-not $processes) {
                Write-Log -Message "No processes found matching '$searchTerm' on $TargetIP."
                [System.Windows.Forms.MessageBox]::Show("No processes found matching '$searchTerm'.", "Info", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
            }
        } catch {
            Write-Log -Message "ERROR: Failed to list processes on $TargetIP. Error: $($_.Exception.Message)"
            [System.Windows.Forms.MessageBox]::Show("Failed to list processes. Error: $($_.Exception.Message)", "Error", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Error)
        }
    })

    $TerminateButton.Add_Click({
        $selectedPids = $ProcessList.CheckedItems | ForEach-Object { $_.SubItems[1].Text }
        if (-not $selectedPids) {
            Write-Log -Message "No processes selected for termination on $TargetIP."
            [System.Windows.Forms.MessageBox]::Show("No processes selected.", "Error", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Error)
            return
        }
        try {
            $result = Invoke-Command -Session $Session -ScriptBlock {
                ...
                foreach ($pid in $pids) {
                    try {
                        ...
                        $output += "PID $pid terminated."
                    } catch {
                        $output += "ERROR: Failed to terminate PID $pid. Error: $($_.Exception.Message)"
                    }
                }
                return $output
            } -ArgumentList $selectedPids
            Write-Log -Message "Process termination results: $($result -join ' ')"
            [System.Windows.Forms.MessageBox]::Show($result -join "`n", "Termination Results", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
        } catch {
            Write-Log -Message "ERROR: Failed to terminate processes on $TargetIP. Error: $($_.Exception.Message)"
            [System.Windows.Forms.MessageBox]::Show("Failed to terminate processes. Error: $($_.Exception.Message)", "Error", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Error)
        }
    })
...
function Prompt-SessionAction {
    ...
    $Form.Size = New-Object System.Drawing.Size(700,200) # Adjusted for additional button
    $Form.StartPosition = "CenterScreen"
    $Form.FormBorderStyle = "FixedDialog"
    $Form.MaximizeBox = $false
    $Form.MinimizeBox = $false
    ...
    $CopyButton.Location = New-Object System.Drawing.Point(10,60)
    ...
    $RunFileButton.Location = New-Object System.Drawing.Point(120,60)
    $RunFileButton.Size = New-Object System.Drawing.Size(100,30)
    ...
    $RunScriptButton.Location = New-Object System.Drawing.Point(230,60)
    $RunScriptButton.Size = New-Object System.Drawing.Size(100,30)
    $RunScriptButton.Text = "Run Script"
    $RunScriptButton.DialogResult = [System.Windows.Forms.DialogResult]::Ignore
    $Form.Controls.Add($RunScriptButton)
    $DeleteButton = New-Object System.Windows.Forms.Button
    $DeleteButton.Location = New-Object System.Drawing.Point(340,60)
    ...
    $CheckUserButton.Location = New-Object System.Drawing.Point(450,60)
    $CheckUserButton.Size = New-Object System.Drawing.Size(100,30)
    ...
    $ManageProcButton = New-Object System.Windows.Forms.Button
    $ManageProcButton.Location = New-Object System.Drawing.Point(560,60)
    $ManageProcButton.Size = New-Object System.Drawing.Size(100,30)
    $ManageProcButton.Text = "Manage Processes"
    $ManageProcButton.DialogResult = [System.Windows.Forms.DialogResult]::Apply
    $Form.Controls.Add($ManageProcButton)
    $ExitButton = New-Object System.Windows.Forms.Button
    $ExitButton.Location = New-Object System.Drawing.Point(670,60)
    $ExitButton.Size = New-Object System.Drawing.Size(100,30)
                ...
                do {
                    ...
                    switch ($SessionAction) {
                        ...
                        ([System.Windows.Forms.DialogResult]::Ignore) {
                            Write-Log -Message "User chose to run a PowerShell script."
                        ...
                        ([System.Windows.Forms.DialogResult]::Apply) {
                            Write-Log -Message "User chose to manage processes."
                            Manage-Processes -Session $Session
                        }
